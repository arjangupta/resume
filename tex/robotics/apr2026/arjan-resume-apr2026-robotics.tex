...
\header{Summary}
\vspace{2mm}
Engineer with 9 years of software engineering experience and 2 years of dedicated robotics engineering expertise, finishing a Master of Science in Robotics Engineering in May 2027. Extremely passionate about building autonomy that augments productivity and safety.
\vspace{3mm}
...
\begin{tabular}{ l l }
    ...
    Embedded:             & PWM, UART, SPI, I2C, MQTT,  HTTPS \\
    Broad skills: & autonomous navigation, localization, computer vision, deep reinforcement learning
\end{tabular}
\vspace{2mm}
...
Master of Science in Robotics Engineering, GPA:\@ 4.00/4.00 \hfill August 2022 --- May 2027\\
\vspace{2mm}
...
\vspace{-1mm}
\begin{itemize}
    \item Led the design, implementation, and performance testing of a local navigation system using a Regulated Pure Pursuit controller in Nav2, augmented by finer compensatory control with a PID curvature controller
    \item Co-led the design and implementation of a motion planning system for ground vehicles
    \item Performed core system engineering for autonomy modules including localization, navigation control, auto-path planning, and kinematics, designing modules extensible across multiple Vermeer machine platforms
    \item Wrote C++ to develop several ROS2 packages and nodes implementing the autonomy modules defined in system engineering processes
    \item Conducted comprehensive analyses of autonomy application across machine groups in the solar, mining, and agriculture industries
    \item Facilitated virtual and on-site meetings with GNSS \& sensing vendors for project proposals, leveraging expertise in embedded engineering
    \item Contextualized autonomy modules for ISO safety standards 17757 and 18497, creating plans to incorporate functional safety, SOTIF, HARA, and other autonomy safety principles
\end{itemize}
...
%==== Projects ====%
\header{Hobby Robotics Projects}
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
