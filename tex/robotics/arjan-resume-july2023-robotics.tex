...
\begin{itemize} \itemsep 1pt
    ...
    \item Path Planning in Lung --- designed a path planning algorithm for a capsule robot to navigate through a human lung, then simulated it in MATLAB
    \item Gazebo Simulation --- created a simulation of a 3 DoF robotic arm, then wrote a ROS node to control it
\end{itemize}
...
\textit{Co-Founder \& Engineering Expert} \hfill June 2023 --- present\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
